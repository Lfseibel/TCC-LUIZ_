...
AlunosDAO.prototype.salvarAluno = function(ra, cpf, rg, email, nome, senha, callback){
	this._connection.query('insert into usuario set nome_usuario = ?,ra_usuario = ?,cpf_usuario = ?,rg_usuario = ?,email_usuario = ?,senha_usuario = ?', [nome, ra, cpf, rg, email, senha], callback);//jason na funcao query e inseri quando acha o ?
}
